...
public interface BookMapper {
    ...
    @Insert("insert into book(title, `desc`, price,publishAddress) values(#{title}, #{desc}, #{price},#{publishAddress})")
    void addBook(@Param("title") String title, @Param("desc") String desc, @Param("price") double price, @Param("publishAddress") String publishAddress);
